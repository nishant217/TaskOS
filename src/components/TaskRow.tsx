  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="max-w-[280px]">
        ...
        {row.original.overdue && <p className="text-xs text-red-500">Overdue</p>}
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-slate-500">{row.original.priorityText}</span>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex items-center gap-2">
        ...
        <span
          className={`text-sm ${
            row.original.overdue ? "text-red-600 font-medium" : "text-slate-600 dark:text-slate-300"
          }`}
        >
          {row.original.date}
        </span>
...
const sampleData: Task[] = [
  {
    id: "TASK-8842",
    title: "Database Migration for Q4 Systems",
    status: "In Progress",
    statusColor: "blue",
    priority: "Medium",
    priorityText: "P2 - Medium",
    assignee: "Alex",
    date: "Oct 28, 2025",
    overdue: false,
  },
...
export default function TasksTanstackTable() {
